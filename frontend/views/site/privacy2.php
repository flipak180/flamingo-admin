...
<div class="site-about">
    ...
    <ol>
        ...
        <li>Мы не запрашиваем Ваш адрес электронной почты или какую нибудь личную информацию о Вас.</li>
        <li>Мы не продаем контент.</li>
        <li>Мы не используем номер телефона для рассылок и не предоставляем его третьим лицам.</li>
        <li>Безопасность Вашей персональной информации не будет нарушена.</li>
        <li>Мы не используем информацию о местоположении в иных целях, не указанных в самом приложении.</li>
